...
//	: DXApp(hInstance), mLandVB(0), mLandIB(0), mWavesVB(0), mWavesIB(0), mFX(0), mTech(0),
...
//}
//
//void WavesDemo::UpdateScenes(float dt)
//{
...
//	HR(m_pDevice->CreateBuffer(&vbd, &vinitData, &mLandVB));
//
//	//
...
//	HR(m_pDevice->CreateBuffer(&ibd, &iinitData, &mLandIB));
//}
//
...
//{
//	std::ifstream fin("hlsl/waves.fxo", std::ios::binary);
//
