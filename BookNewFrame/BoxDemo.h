...
//	: DXApp(hInstance), mBoxVB(0), mBoxIB(0), mFX(0), mTech(0),
...
//}
//
//void BoxApp::UpdateScenes(float dt)
//{
...
//		mPhi = MathHelper::Clamp(mPhi, 0.01f, MathHelper::Pi - 0.01f);
//	}
...
//	HRESULT hr = D3DX11CompileFromFile(L"hlsl/color.fx", 0, 0, 0, "fx_5_0", shaderFlags,
