...
//};
//
//class LightingApp : public DXApp
//{
//public:
...
//: DXApp(hInstance), mLandVB(0), mLandIB(0), mWavesVB(0), mWavesIB(0), 
...
//}
//
//void LightingApp::UpdateScenes(float dt)
//{
...
//{
//	std::ifstream fin("hlsl/Lighting.fxo", std::ios::binary);
//
